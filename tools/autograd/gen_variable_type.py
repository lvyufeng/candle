...
def gen_variable_type_pyx(infos: list) -> str:  # type: ignore[type-arg]
    ...
    is added in Task 3 and will replace this body.
    """
    # TODO(Task 3): generate full Cython forward wrapper bodies here.
    return (
        '# cython: language_level=3\n'
        '# Auto-generated Cython forward autograd wrappers — DO NOT EDIT.\n'
        '# Generated by tools/autograd/gen_variable_type.py from derivatives.yaml.\n'
        '# NOTE: This is a Task-2 placeholder stub.  Task 3 will fill in the\n'
        '#       real Cython wrapper bodies.  Until then the Python fallback\n'
        '#       (variable_type.py) is used at runtime.\n'
    )
